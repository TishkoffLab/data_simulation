...
######### Simulates 4 human populations and 1 Archaic popultion. Introgression occurs from AFR1 to Altai
...
def HumanIntrogression_4Pops(random_seed=None):
    ts = msprime.simulate(
        ...
        demographic_events = [
            ...
            ### Modern Human Introgression into Altai from AFR1 at 50,000 years ago
            ...
            #msprime.MassMigration(time = (50000/30),
            #source=AFR4, destination=AFR3, proportion=1),  
...
#    dd.print_history()
    ...
    return ts
ts = HumanIntrogression_4Pops(NUM)
